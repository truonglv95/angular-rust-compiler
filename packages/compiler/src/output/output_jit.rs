...
impl<'a> JitEmitterVisitor<'a> {
    ...
    pub fn visit_wrapped_node_expr(&mut self, _expr: &o::WrappedNodeExpr, _ctx: &mut EmitterVisitorContext) {
...
impl<'a> o::ExpressionVisitor for JitEmitterVisitor<'a> {
    ...
    fn visit_tagged_template_expr(&mut self, expr: &o::TaggedTemplateLiteralExpr, context: &mut dyn std::any::Any) -> Box<dyn std::any::Any> {
    ...
    fn visit_localized_string(&mut self, expr: &o::LocalizedString, context: &mut dyn std::any::Any) -> Box<dyn std::any::Any> {
