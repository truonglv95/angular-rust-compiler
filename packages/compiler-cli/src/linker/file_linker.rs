...
where A::Expression: Clone + AstNode
{
...
where A::Expression: Clone + AstNode
{
    ...
    pub fn link_partial_declaration(
        ...
        let obj = value.get_object().map_err(|_| "Metadata is not an object".to_string())?;
        ...
        let _definition = linker.link_partial_declaration(&mut constant_pool, &obj, source_url, "0.0.0", None);
